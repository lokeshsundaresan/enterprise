...
@WebServlet("/EditDTHSetBox")
public class EditDTHSetBox extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		DTH dao=new DTH();
		ArrayList<DTHmodel> al=dao.preEdit(model);
		...
		session.setAttribute("preEditSet", al);
		
		RequestDispatcher rd=request.getRequestDispatcher("EditDTHSetBox.jsp");
